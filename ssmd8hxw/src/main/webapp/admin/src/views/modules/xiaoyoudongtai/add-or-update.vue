<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="信息类别" prop="xinxileibie">
          <el-input v-model="ruleForm.xinxileibie" 
              placeholder="信息类别" clearable  :readonly="ro.xinxileibie"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="信息类别" prop="xinxileibie">
              <el-input v-model="ruleForm.xinxileibie" 
                placeholder="信息类别" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
...
export default {
  data() {
	...
	clicknum : false,
      ...
      rules: {
          ...
          xinxileibie: [
                { required: true, message: '信息类别不能为空', trigger: 'blur' },
          ],
          jianjie: [
          ],
          neirong: [
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.biaoti = true;
          ...
          if(o=='xinxileibie'){
            this.ruleForm.xinxileibie = obj[o];
	    this.ro.xinxileibie = true;
            continue;
          }
          if(o=='jianjie'){
	...
	this.ruleForm.neirong = this.ruleForm.neirong.replace(reg,'../../../ssmd8hxw/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `xiaoyoudongtai/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.xiaoyoudongtaiCrossAddOrUpdateFlag = false;
                  this.parent.search();
