	...
	export default {
		...
		async onLoad(options) {
			...
			if (options.id) {
				...
				// 获取信息
				res = await this.$api.info(`xiaoyoudongtai`, this.ruleForm.id);
		...
		methods: {
			...
			async onSubmitTap() {
					...
					return
																																												...
																																												if((!this.ruleForm.xinxileibie)){
					this.$utils.msg(`信息类别不能为空`);
					return
				}
					...
					return
																																				...
																																				if(this.ruleForm.id){
					await this.$api.update(`xiaoyoudongtai`, this.ruleForm);
				}else{
					await this.$api.add(`xiaoyoudongtai`, this.ruleForm);
				}
